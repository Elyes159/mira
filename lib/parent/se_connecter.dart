...
import 'package:mira/parent/inscription.dart';

class ParentLogin extends StatefulWidget {
  @override
  _ParenLoginState createState() => _ParenLoginState();
}

class _ParenLoginState extends State<ParentLogin> {
                    ...
                    Center(
                      child: TextButton(
                        onPressed: () {
                          Navigator.of(context).push(
                            MaterialPageRoute(
                                builder: (context) => PrentInscriptionPage()),
                          );
                        },
                        child: Text(
                          "Inscrivez-vous",
